...
<?php
	if($Archivos_Chat_Otros != "" && $Archivos_Chat_Otros["totalCount"] > 0) {
?>
		<page backtop="5mm" backbottom="5mm" backleft="1mm" backright="1mm" orientation="portrait">
			<page_footer footer='page'>
				<div class="div-footer">
						...
						if($Archivos_Chat_Otros["totalCount"] > 0) {
							for($m = 0; $m < $Archivos_Chat_Otros["totalCount"]; $m++) {
								if($Archivos_Chat_Otros["data"][$m]["Url_Adjunto"] != null && $Archivos_Chat_Otros["data"][$m]["Url_Adjunto"] != "") {
									...
									?>
									<tr>
										<td class="td-imagen-adjunto" style="width: 100%;">
												<!--<a href="https://apps2.hospitalsatelite.com/siga/Archivos/Archivos-Chat/<?php //echo $Archivos_Chat_Otros["data"][$m]["Url_Adjunto"]; ?>" 
													 target="_blank">
