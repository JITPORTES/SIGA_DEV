...
?>
     <div class="modal fade modalchs" id="acumulada-fiscal">
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header azuldef">
            <button type="button" class="close" aria-label="Close" id="botonFiscalClosePopup">
                  ...
                  <table id="example1" class="table table-bordered table-striped table-chs" width="100%">
                    ...
                    <tbody>
                      ...
                      <tr>
						...
						<td style="<?php echo $style_size_table;?>"><?php echo $anios[$i]["MesesVida"] ?></td>
						...
						<td><?php echo number_format($anios[$i]["Factor"],4) ?></td>
	...
	function cerrarPop()
	{
		$("#acumulada-fiscal").remove();
		//$("#botonClosePopup").click();
	}
	$("#botonFiscalClosePopup").click(function(e){
		$("#acumulada-fiscal").remove();
	});
